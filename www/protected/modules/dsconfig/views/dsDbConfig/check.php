...
echo '<p>';
echo Yii::t('dsconfigModule.app', 'The config items below show you if your database connection is set up properly:');
...
{
    $value = (array_key_exists($key, $dbparams)) ? $dbparams[$key] : '';
    $notice = '';
