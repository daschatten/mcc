...
/**
 * This is the model base class for the table "record_tmp".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "RecordTmp".
 *
 * Columns in table "record_tmp" available as properties of the model,
 ...
 *
 */
abstract class BaseRecordTmp extends GxActiveRecord {
	...
	public static function label($n = 1) {
		return Yii::t('app', 'RecordTmp|RecordTmps', $n);
	}
	...
	public function rules() {
		return array(
			array('next_record, last_record, last_delete', 'required'),
			array('recpriority, autoexpire, maxepisodes, maxnewest, startoffset, endoffset, dupmethod, dupin, autotranscode, autocommflag, autouserjob1, autouserjob2, autouserjob3, autouserjob4, findday, findid, inactive, parentid, transcoder, prefinput, avg_delay', 'numerical', 'integerOnly'=>true),
			array('type, chanid, search', 'length', 'max'=>10),
			...
			array('type, chanid, starttime, startdate, endtime, enddate, title, subtitle, description, category, profile, recpriority, autoexpire, maxepisodes, maxnewest, startoffset, endoffset, recgroup, dupmethod, dupin, station, seriesid, programid, search, autotranscode, autocommflag, autouserjob1, autouserjob2, autouserjob3, autouserjob4, findday, findtime, findid, inactive, parentid, transcoder, playgroup, prefinput, storagegroup, avg_delay', 'default', 'setOnEmpty' => true, 'value' => null),
			array('recordid, type, chanid, starttime, startdate, endtime, enddate, title, subtitle, description, category, profile, recpriority, autoexpire, maxepisodes, maxnewest, startoffset, endoffset, recgroup, dupmethod, dupin, station, seriesid, programid, search, autotranscode, autocommflag, autouserjob1, autouserjob2, autouserjob3, autouserjob4, findday, findtime, findid, inactive, parentid, transcoder, playgroup, prefinput, next_record, last_record, last_delete, storagegroup, avg_delay', 'safe', 'on'=>'search'),
		);
	}
