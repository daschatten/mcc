<?php
$imghtml=CHtml::image(Yii::app()->getBaseUrl(true).'/images/arrow-left.png', Yii::t('app', 'Back to recordings list')).Yii::t('app', 'Back to recordings list');
...
<div id="recordingInfoMain">
    <table>
        <tr>
            <td><?= Yii::t('app', 'Date') ?></td><td><span id="recordingDate"><?= Yii::app()->dateFormatter->formatDateTime($model->localStarttime, 'short', 'short') ?></span></td>
        </tr>
        <tr>
